        ...
        <Grid container spacing={5}>
          <Grid item xs={12} md={12}>
            ...
            <Typography style={{ display: 'flex', justifyContent: 'center' }}>
              Ranked #1 Worldwide Best Parallel Bible Books App, Free App, The Easiest Way To Comprehend The Scriptures
              By Jorge Carrasco, #parallelbiblejorge, #bibliaparalelajorge, #bible,
            </Typography>
